...
class VCStore:
    ...
    def _verify_synced_presentation_against(
        ...
        字段、holder_* 禁令、挑战、锚点、签名覆盖、验签与期限规则及
        原因分类与 :meth:`verify_trust_presentation_synced` 完全一致。
        """
